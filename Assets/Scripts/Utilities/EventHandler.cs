...
public static class EventHandler 
{
    ...
    public static event Action<Vector3, ItemDetails> ExecuteActionAfterAnimaion;
    public static void CallExecuteActionAfterAnimaion(Vector3 pos,ItemDetails itemDetails)
    {
        ExecuteActionAfterAnimaion?.Invoke(pos,itemDetails);
    }
